...
| `brand` | `BrandSlice` | Unified brand voice (authority-resolved block) + approved identity (structured + prompt block). Read-only; non-formattable; assembled on request. |
