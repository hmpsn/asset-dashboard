...
### Reference
See `docs/workflows/auth-system.md` for full auth system documentation including all endpoints, middleware stack, and common tasks.
...
4. **AI Summary**: `generateAiSummary()` calls the utility-extraction model (see `server/model-manifest.ts`) for a 2-3 sentence executive summary per workspace
...
**Enforcement**: See `docs/rules/data-flow.md` for mandatory rules and `docs/workflows/new-feature-checklist.md` for the pre/during/post implementation checklist.
