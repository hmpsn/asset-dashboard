...
export const DEPRECATION_REGISTRY: DeprecationEntry[] = [
  ...
  {
    id: 'keyword-hub-navigation-hidden-until-cutover',
    capability: 'Keyword Hub unified navigation hidden until rollout cutover',
    state: 'hidden',
    owner: 'analytics-intelligence',
    replacement: 'Use the existing Keywords and Rank Tracker admin entries until keyword-hub is enabled.',
    requiresHumanVerification: false,
    notes: 'The unified Keyword Hub remains behind its active rollout flag while the legacy keyword surfaces stay available.',
    contracts: [
      {
        kind: 'visibility-gate',
        description: 'Sidebar shows Keywords and Rank Tracker while keyword-hub is off, then swaps to Keyword Hub when enabled.',
        evidence: 'src/components/layout/Sidebar.tsx (keyword-hub nav fold-in)',
        testEvidence: 'tests/component/Sidebar.test.tsx (keyword-hub nav fold-in)',
      },
    ],
  },
  {
