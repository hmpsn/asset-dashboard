...
**Phase 1B (intelligence computation engine) is deferred to Opus — requires novel algorithm design for page health scoring, quick win detection, content decay, and cross-module aggregation.**
