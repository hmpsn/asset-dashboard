...
function mergeIncrementalPageKeyword(previous: PageKeywordMap | undefined, next: PageKeywordMap): PageKeywordMap {
  ...
  return {
    ...
    cpcSource: next.cpc != null ? (next.cpcSource ?? previous.cpcSource) : previous.cpcSource,
    intentSource: next.searchIntent != null ? (next.intentSource ?? previous.intentSource) : previous.intentSource,
