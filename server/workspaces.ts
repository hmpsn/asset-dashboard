...
export function updatePageState(
  ...
  if (existingRow) {
    existing = {
      ...
      auditIssues: parseJsonSafeArray(existingRow.audit_issues, z.string(), { workspaceId, field: 'audit_issues', table: 'page_edit_states' }) || undefined,
      fields: parseJsonSafeArray(existingRow.fields, z.string(), { workspaceId, field: 'fields', table: 'page_edit_states' }) || undefined,
...
export function getPageState(workspaceId: string, pageId: string): PageEditState | undefined {
  ...
  return {
    ...
    auditIssues: parseJsonSafeArray(row.audit_issues, z.string(), { workspaceId, field: 'audit_issues', table: 'page_edit_states' }) || undefined,
    fields: parseJsonSafeArray(row.fields, z.string(), { workspaceId, field: 'fields', table: 'page_edit_states' }) || undefined,
