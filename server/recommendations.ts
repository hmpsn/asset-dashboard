...
export function mapToProduct(
  ...
  switch (recType) {
    ...
    // PRODUCT_MAP, so the CTA they produced failed isProductType at cart
    // checkout. Restore a case here ONLY together with real PRODUCT_MAP entries
