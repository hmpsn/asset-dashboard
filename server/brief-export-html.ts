...
<style>
  @page {
    ...
    @bottom-center {
      ...
      font-size: 8px; color: #94a3b8; letter-spacing: 0.5px;
    }
    @bottom-right {
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .guide-box .guide-title { font-size: 11px; font-weight: 700; color: #1e40af; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px; }
  .guide-box p { font-size: 11px; color: #334155; line-height: 1.6; }

  /* Table of contents */
  .toc { margin-bottom: 28px; padding: 20px 24px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; }
  .toc-title { font-size: 10px; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; }
  .toc-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 4px 24px; }
  .toc-item { font-size: 11px; color: #475569; padding: 2px 0; display: flex; align-items: center; gap: 6px; }
  ...
  .tags-label { font-size: 9px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600; margin-bottom: 6px; display: block; }
  ...
  .outline-num { font-size: 10px; font-weight: 700; color: #0d9488; margin-bottom: 4px; text-transform: uppercase; letter-spacing: 0.5px; }
  ...
  .cta-badge { font-size: 9px; padding: 3px 10px; border-radius: 6px; font-weight: 600; flex-shrink: 0; text-transform: uppercase; letter-spacing: 0.3px; }
  ...
  /* Footer */
  .footer { margin-top: 48px; padding-top: 20px; border-top: 2px solid #0d9488; text-align: center; font-size: 11px; color: #64748b; break-inside: avoid; }
  .footer a { color: #0d9488; text-decoration: none; font-weight: 600; }
  .footer .disclaimer { font-size: 9px; color: #94a3b8; margin-top: 8px; max-width: 480px; margin-left: auto; margin-right: auto; line-height: 1.5; }
</style>
</head>
<body>
