...
<div class="header">
  ...
  <div style="font-size:11px; color:#9ca3af; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:16px;">Prepared by ${escHtml(STUDIO_NAME)}</div>
...
<div class="footer">
  ...
  <p style="margin-top:4px;">Prepared by <a href="${escHtml(STUDIO_URL)}" style="color:#2ed9c3; text-decoration:none;">${escHtml(STUDIO_NAME)}</a></p>
</div>
