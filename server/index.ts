...
app.post('/api/public/recommendations/:workspaceId/generate', async (req, res) => {
  try {
...
app.get('/api/public/recommendations/:workspaceId', async (req, res) => {
  try {
...
app.patch('/api/public/recommendations/:workspaceId/:recId', (req, res) => {
...
app.delete('/api/public/recommendations/:workspaceId/:recId', (req, res) => {
