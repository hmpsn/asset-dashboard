        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <FormSelect
              ...
              className="appearance-none pl-3 pr-8 py-2 bg-[var(--surface-2)] border border-[var(--brand-border)] rounded-[var(--radius-lg)] text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-400/60 cursor-pointer"
            />
        ...
        {filteredPages.map(page => (
          ...
          <div key={page.page} className="bg-[var(--surface-2)] border border-[var(--brand-border)] overflow-hidden rounded-[var(--radius-signature-lg)]">
            <ClickableRow
              ...
              className="flex items-center gap-3 px-4 py-3 hover:bg-[var(--surface-3)]/50 text-left rounded-none"
            >
