...
import { RefreshCw, AlertTriangle, AlertCircle, Eye, Sparkles, ArrowDown, ArrowUp } from 'lucide-react';
                        ...
                        <div className="px-4 pb-3 pl-13 space-y-2">
                          ...
                          {page.refreshRecommendation && (
                            <div className="bg-accent-brand-soft border border-accent-brand-soft rounded-[var(--radius-lg)] p-3 mt-2">
                              <div className="flex items-center gap-1.5 t-caption-sm font-medium text-accent-brand mb-2">
