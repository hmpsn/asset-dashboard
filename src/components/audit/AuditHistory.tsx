      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-zinc-900 p-5 border border-zinc-800" style={{ borderRadius: '6px 12px 6px 12px' }}>
          ...
          <div className="flex items-end gap-2">
            ...
            {scoreDelta !== 0 && (
              <span className={`flex items-center gap-0.5 text-xs font-medium pb-1 ${scoreDelta > 0 ? 'text-emerald-400' : 'text-red-400'}`}>
        ...
        <div className="bg-zinc-900 p-5 border border-zinc-800" style={{ borderRadius: '6px 12px 6px 12px' }}>
          ...
          <div className="flex items-end gap-2">
            ...
            {errorDelta !== 0 && previous && (
              <span className={`text-xs font-medium pb-1 ${errorDelta < 0 ? 'text-emerald-400' : 'text-red-400'}`}>
              ...
              <div key={snap.id} className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-zinc-900/50 transition-colors group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-zinc-500">
                    ...
                    {delta !== 0 && (
                      <span className={`ml-2 ${delta > 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                        ({delta > 0 ? '+' : ''}{delta} pts)
                      </span>
                    )}
                  </div>
