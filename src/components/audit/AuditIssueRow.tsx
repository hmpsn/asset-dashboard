  ...
  return (
    <div key={idx} className="flex items-start gap-3 px-4 py-2 rounded-lg hover:bg-zinc-800/30 transition-colors group/issue">
        ...
        {issue.suggestedFix && (
          <div className="mt-1.5 px-2 py-1.5 rounded bg-emerald-950/40 border border-emerald-800/30">
            <div className="flex items-center justify-between mb-0.5">
              ...
              {isApplied ? (
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-green-500/20 text-emerald-400 font-medium flex items-center gap-1">
      ...
      <div className="flex items-center gap-1 flex-shrink-0 mt-0.5">
        ...
        {isCreated && (
          <span className="text-[10px] px-1 py-0.5 rounded bg-green-500/10 text-emerald-400 border border-green-500/20 flex items-center gap-0.5">
