...
export function BulkActions({
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2.5 bg-[var(--surface-2)] border border-[var(--brand-border-hover)] rounded-[var(--radius-md)] text-sm sticky bottom-4 mt-4 z-[var(--z-dropdown)] shadow-lg shadow-black/30">
