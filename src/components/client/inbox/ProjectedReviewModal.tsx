...
export function ProjectedReviewModal({
  ...
  return (
    ...
    >
      ...
      {/* ISSUE 2c — SOLO panel: the bespoke surfaces render only the opened item (no PageHeader /
          stat grid / multi-entry chrome), so the single-item review stays focused. Centered modal
          shell matches DeliverableDetailModal (item 3). */}
      <div
