              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {req.upgradedAt && <span className="text-[11px] px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-medium">Upgraded</span>}
                  </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-1">
                            {brief.serpAnalysis.gaps.map((g: string, i: number) => (
                              <div key={i} className="text-[11px] text-emerald-300/80 flex items-start gap-1.5 bg-zinc-950 rounded-lg px-3 py-2 border border-zinc-800">
