                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {req.upgradedAt && <span className="text-[11px] px-1 py-0.5 rounded bg-green-500/10 text-emerald-400 border border-green-500/20">Upgraded</span>}
                    </div>
                    ...
                    <div>
                      ...
                      <div className="bg-zinc-950 rounded-lg px-3 py-3 border border-zinc-800 space-y-2">
                        ...
                        {inlineBrief.serpAnalysis.gaps.length > 0 && (
                          <div><span className="text-[11px] text-emerald-400/80 block mb-1">Opportunities (gaps in existing content):</span><div className="space-y-1">{inlineBrief.serpAnalysis.gaps.map((g, i) => <div key={i} className="text-[11px] text-green-300/80 flex items-start gap-1.5"><span className="text-emerald-400 mt-0.5">→</span>{g}</div>)}</div></div>
                        )}
                      </div>
                    </div>
                  )}
