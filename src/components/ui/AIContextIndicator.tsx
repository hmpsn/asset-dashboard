              ...
              >
                ...
                {!isConnected && source.fixAction && (
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-0.5 rounded-[var(--radius-sm)] t-label normal-case tracking-normal bg-[var(--surface-3)] text-[var(--brand-text)] hover:text-[var(--brand-text-bright)] hover:bg-[var(--brand-border-hover)] transition-colors flex-shrink-0"
                  >
