...
import {
  ...
  Shield, DollarSign, ArrowUpRight, Code2, Plus,
} from 'lucide-react';
import { adminPath } from '../routes';
import { scoreColorClass, scoreBgBarClass, MetricRing, TabBar, Icon, Button } from './ui';
...
import type { BulkProgress, ContentScore, KeywordData, SeoCopy, SortBy } from './page-intelligence/pageIntelligenceTypes';
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      <PageIntelligencePagesHeader
        ...
        onToggleFixQueuePage={pageId => setExpanded(expanded === pageId ? null : pageId)}
