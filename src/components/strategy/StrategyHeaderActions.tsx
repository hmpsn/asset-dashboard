...
import type { StrategyHeaderActionsProps } from './types';

/**
 * The regeneration button cluster for the Strategy page header. Rendered into the
 * orchestrator's <PageHeader actions={...}> slot — the page itself owns the PageHeader.
 */
export function StrategyHeaderActions({
  isRealStrategy,
  generating,
  localSyncApplies,
  localNeedsRefresh,
