                      ...
                      <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-1 flex-wrap justify-end">
                          ...
                          {req.status === 'in_progress' && (
                            <button onClick={() => handleUpdateRequestStatus(req.id, 'delivered')} className="px-2 py-1 rounded bg-green-600/20 border border-green-500/30 text-[11px] text-green-300 hover:bg-green-600/30 transition-colors">Mark Delivered</button>
                          )}
                        </div>
                      </div>
                    </div>
