    ...
    return (
      <div className="flex flex-col items-center justify-center py-10 gap-4 animate-[scaleIn_0.3s_ease-out]">
        ...
        <div className="text-center">
          <div className="text-sm font-semibold text-zinc-100">Payment Successful</div> {/* raw-zinc-ok */}
          <div className="text-xs text-zinc-500 mt-1">{fmt(amount)} paid for {productName}</div> {/* raw-zinc-ok */}
        </div>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        ...
        onClick={onCancel}
        disabled={processing}
        className="w-full px-4 py-2 rounded-[var(--radius-xl)] text-xs text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800/50 transition-all flex items-center justify-center gap-1.5" // raw-zinc-ok
      >
      ...
      <div className="flex items-center justify-center gap-4 pt-1">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-zinc-500">SSL Encrypted</span> {/* raw-zinc-ok */}
        </div>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-zinc-500">Powered by Stripe</span> {/* raw-zinc-ok */}
        </div>
      </div>
    </form>
  );
      ...
      >
        ...
        <div className="relative px-6 pt-6 pb-4 overflow-hidden bg-gradient-to-br from-teal-600/15 via-emerald-600/10 to-transparent">
          ...
          <div className="relative">
            <div className="text-sm font-semibold text-zinc-100 mb-1">{productName}</div> {/* raw-zinc-ok */}
            <div className="text-xs text-zinc-500">{topic}</div> {/* raw-zinc-ok */}
          ...
          <div className="inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 rounded-[var(--radius-lg)] border bg-teal-500/5 border-teal-500/20">
            ...
            <span className="text-xs text-zinc-500">one-time</span> {/* raw-zinc-ok */}
          </div>
        </div>
