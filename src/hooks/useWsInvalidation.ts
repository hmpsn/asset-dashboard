...
export function useWsInvalidation(workspaceId: string | undefined) {
  ...
  useWorkspaceEvents(workspaceId, {
    ...
    [WS_EVENTS.WORKSPACE_UPDATED]: (data: unknown) => invalidateRegistry(WS_EVENTS.WORKSPACE_UPDATED, data),
    ...
    [WS_EVENTS.FORM_CAPTURE_CONFIG_UPDATED]: () => invalidateRegistry(WS_EVENTS.FORM_CAPTURE_CONFIG_UPDATED),
    ...
    [WS_EVENTS.STRATEGY_KEYWORD_SET_UPDATED]: () => invalidateRegistry(WS_EVENTS.STRATEGY_KEYWORD_SET_UPDATED),
    [WS_EVENTS.RANK_TRACKING_UPDATED]: () => invalidateRegistry(WS_EVENTS.RANK_TRACKING_UPDATED),
    [WS_EVENTS.SERP_SNAPSHOTS_REFRESHED]: () => invalidateRegistry(WS_EVENTS.SERP_SNAPSHOTS_REFRESHED),
    [WS_EVENTS.LOCAL_GBP_SNAPSHOTS_REFRESHED]: () => invalidateRegistry(WS_EVENTS.LOCAL_GBP_SNAPSHOTS_REFRESHED),
    [WS_EVENTS.GBP_CONNECTION_UPDATED]: () => invalidateRegistry(WS_EVENTS.GBP_CONNECTION_UPDATED),
    [WS_EVENTS.GBP_REVIEWS_UPDATED]: () => invalidateRegistry(WS_EVENTS.GBP_REVIEWS_UPDATED),
    [WS_EVENTS.GBP_REVIEW_RESPONSES_UPDATED]: () => invalidateRegistry(WS_EVENTS.GBP_REVIEW_RESPONSES_UPDATED),
    [WS_EVENTS.LLM_MENTIONS_SNAPSHOTS_REFRESHED]: () => invalidateRegistry(WS_EVENTS.LLM_MENTIONS_SNAPSHOTS_REFRESHED),
