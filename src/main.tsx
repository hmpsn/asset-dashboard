...
// in src/api/client.ts — including NDJSON wrappers in src/api/seo.ts
// (bulkGenerateAltText) that can't use post()/getText() because those consume
// the full response body. Do not remove without updating those wrappers to
// set x-auth-token themselves.
